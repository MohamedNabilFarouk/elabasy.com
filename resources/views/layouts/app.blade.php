...
<footer class="app-footer">
    <div>
        <a href="#"> </a>
        <span>&copy; 2021 MohamedNabil.</span>
    </div>
    <div class="ml-auto">
        <span>Powered by</span>
        <a href="https://api.whatsapp.com/send?phone=201011941903&text=اقدر اساعدك ازاي؟." class="float" target="_blank">MohamedNabil</a>
    </div>
</footer>
</body>
<!-- jQuery 3.1.1 -->
